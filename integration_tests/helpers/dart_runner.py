"""Subprocess manager for Dart interop helper scripts."""
...
DART_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "dart")


class DartHelper:
    """Wraps a Dart subprocess with JSON-line event reading."""

    def __init__(self, script: str, args: list[str]):
        cmd = ["dart", "run", f"bin/{script}", *args]
